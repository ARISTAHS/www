      ...
      <!-- 본문 시작 -->
			...
			<div class="photo_bbs_wrap">
					...
					<div class="bbs_sort">
						...
						<ul class="lst_style">
							<li class="active"><a href="list.php?liststyle=list&scale=<?=$scale?>"><i class="fa-regular fa-table-list"></i> <span class="hidden">목록형</span></a></li>
							<li><a href="list.php?liststyle=box&scale=<?=$scale?>"><i class="fa-regular fa-border-all"></i><span class="hidden">박스형</span></a></li>
						</ul>
					</div>
